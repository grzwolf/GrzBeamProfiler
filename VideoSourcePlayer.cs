...
namespace AForge.ControlsGrz
{
    ...
    public partial class VideoSourcePlayer : Control
    {
        ...
        private bool rotate180NoFlip = false; 
        ...
        /// <summary>
        /// Gets or sets whether the player will rotate the image by 180°
        /// </summary>
        /// 
        [DefaultValue(false)]
        public bool Rotate180NoFlip
        {
            get { return rotate180NoFlip; }
            set
            {
                rotate180NoFlip = value;
                Invalidate();
            }
        }
                    ...
                    if ( (currentFrame != null) && (lastMessage == null) ) {
                        ...
                        if ( keepRatio ) {
                            ...
                            if ( rect.Width < rect.Height * ratio ) {
                                newRect.Height = (int)System.Math.Round((double)rect.Width / ratio);
                            } else {
                                newRect.Width = (int)System.Math.Round((double)rect.Height * ratio);
                            }
        ...
        private void videoSource_NewFrame( object sender, NewFrameEventArgs eventArgs )
        {
            if ( !requestedToStop )
            {
                ...
                if ( rotate180NoFlip ) 
                {
                    newFrame.RotateFlip(RotateFlipType.Rotate180FlipNone);
                }
